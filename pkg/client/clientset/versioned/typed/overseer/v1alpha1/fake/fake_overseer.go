...
func (c *FakeOverseers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Overseer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(overseersResource, c.ns, name), &v1alpha1.Overseer{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Overseer), err
}
...
func (c *FakeOverseers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OverseerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(overseersResource, overseersKind, c.ns, opts), &v1alpha1.OverseerList{})
	...
	list := &v1alpha1.OverseerList{ListMeta: obj.(*v1alpha1.OverseerList).ListMeta}
	for _, item := range obj.(*v1alpha1.OverseerList).Items {
...
func (c *FakeOverseers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(overseersResource, c.ns, opts))
...
func (c *FakeOverseers) Create(ctx context.Context, overseer *v1alpha1.Overseer, opts v1.CreateOptions) (result *v1alpha1.Overseer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(overseersResource, c.ns, overseer), &v1alpha1.Overseer{})
...
func (c *FakeOverseers) Update(ctx context.Context, overseer *v1alpha1.Overseer, opts v1.UpdateOptions) (result *v1alpha1.Overseer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(overseersResource, c.ns, overseer), &v1alpha1.Overseer{})
...
func (c *FakeOverseers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(overseersResource, c.ns, name), &v1alpha1.Overseer{})
...
func (c *FakeOverseers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(overseersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.OverseerList{})
	return err
}
...
func (c *FakeOverseers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Overseer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(overseersResource, c.ns, name, pt, data, subresources...), &v1alpha1.Overseer{})

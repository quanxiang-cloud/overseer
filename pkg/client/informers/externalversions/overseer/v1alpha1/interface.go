...
type Interface interface {
	...
	// Overseers returns a OverseerInformer.
	Overseers() OverseerInformer
...
// Overseers returns a OverseerInformer.
func (v *version) Overseers() OverseerInformer {
	return &overseerInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

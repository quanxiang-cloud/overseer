...
${CODEGEN_PKG}/generate-groups.sh "client,lister,informer" \
    github.com/quanxiang-cloud/overseer/pkg/client  github.com/quanxiang-cloud/overseer/pkg/apis \
    "overseer:v1alpha1" \
    --output-base "${TEMP_DIR}" \
    --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.go.txt
   
# Copy everything back.
cp -r "${TEMP_DIR}/github.com/quanxiang-cloud/overseer/." "${SCRIPT_ROOT}/"

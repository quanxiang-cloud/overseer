...
//+kubebuilder:rbac:groups=overseer.quanxiang.cloud.io,resources=overseers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=overseer.quanxiang.cloud.io,resources=overseers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=overseer.quanxiang.cloud.io,resources=overseers/finalizers,verbs=update

...
func (in *OverseerRunStatus) DeepCopyInto(out *OverseerRunStatus) {
	*out = *in
	if in.ResourceRef != nil {
		...
		*out = make(map[string]RefCondition, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RefCondition) DeepCopyInto(out *RefCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RefCondition.
func (in *RefCondition) DeepCopy() *RefCondition {
	if in == nil {
		return nil
	}
	out := new(RefCondition)
	in.DeepCopyInto(out)
	return out
}
